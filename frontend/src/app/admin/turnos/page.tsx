...
import { useGlobalData, Paciente, Turno, Historial, ConfiguracionDia } from '../components/GlobalDataContext';
import { 
  Calendar, 
  Users, 
  FileText, 
...
export default function AdminDashboard() {
  ...
  return (
    <>
            ...
            <div className="flex flex-wrap items-center gap-5">
              ...
              <div className="flex flex-wrap items-center gap-2">
                ...
                <input 
                  ...
                  className="px-3.5 py-2 border border-slate-800 bg-slate-950 rounded-xl text-sm font-extrabold focus:outline-none focus:border-emerald-500 text-white cursor-pointer text-center [&::-webkit-calendar-picker-indicator]:hidden [&::-webkit-calendar-picker-indicator]:opacity-0"
                />
      ...
      {isRegisteringQuick && (
        <LoadingSpinner message="Registrando paciente..." />
      )}
    </>
  );
}